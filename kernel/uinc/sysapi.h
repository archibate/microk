...
__SYS_STATIC syscall3(int,openat,(int fd, const char *name, unsigned int oattr), fd, name, oattr);
...
__SYS_STATIC syscall3(int,dircreat,(int fd, const char *name, unsigned int iattr), fd, name, iattr);
__SYS_STATIC syscall2(int,mktxtinf,(const char *name, size_t size), name, size);
__SYS_STATIC syscall2(int,mkshmem,(const char *name, size_t size), name, size);
